...
impl VideoRecording {
    pub fn new(id: String, recording_start: Option<i64>, recording_end: Option<i64>, recording_file_name: String, gcode_file_minus_name: Option<String>, cloud_sync_start: Option<i64>, cloud_sync_end: Option<i64>) -> VideoRecording {
        VideoRecording {
            id,
            recording_start,
            recording_end,
