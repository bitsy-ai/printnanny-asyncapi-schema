...
impl OctoPrintJobProgress {
    pub fn new(completion: Option<f64>, filepos: Option<i32>, print_time: Option<i32>, print_time_left: Option<i32>, print_time_left_origin: Option<String>) -> OctoPrintJobProgress {
