...
impl VideoStreamSettings {
    pub fn new(
        camera: crate::CameraSettings,
        detection: crate::DetectionSettings,
        hls: crate::HlsSettings,
        recording: crate::RecordingSettings,
        rtp: crate::RtpSettings,
        snapshot: crate::SnapshotSettings,
    ) -> VideoStreamSettings {
        VideoStreamSettings {
