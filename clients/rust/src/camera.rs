...
impl Camera {
    pub fn new(index: i32, device_name: String, framerate: Option<i32>, label: String, src_type: crate::CameraSourceType, selected_caps: crate::GstreamerCaps, available_caps: Vec<crate::GstreamerCaps>) -> Camera {
        Camera {
            index,
            device_name,
            framerate,
